  ...
  const childToParent = async (childdata, type) => {
    ...
    if (response.data.status == 200) {
      ...
      if(type == 'Colors'){
        ...
        dispatch(productionColorlookupOpen({ materialRecID: 0, productionCardID: 0 }));
      }
