...
const Editdeliverychalan = () => {
  ...
  console.log("🚀 ~ Editdeliverychalan ~ detailInitialvalues:", detailInitialvalues)

   const [ indentFlag, setIndentFlag ] = useState(false); 
   const [ jobworkFlag, setJobworkFlag ] = useState(false); 
  ...
  const selectcelldata = (data, bMode, field) => {
    ...
    if (bMode == "A") {
      ...
      if (field == "action") {
        setIniItem(true);
        setIndentFlag(data.Indentflag == 'Y' ? true : false)
        setJobworkFlag(data.Jobworkflag == 'Y' ? true : false)
        setDetaildata({
  ...
  const fnchalanDetailsave = async (values, resetForm, del) => {
    ...
    const idata = {
      ...
      Indentflag: indentFlag === true ? "Y" : "N",
      Jobworkflag: jobworkFlag === true ? "Y" : "N",
      NetPrice: (
                    ...
                    >
                     ...
                     {parentID == "MI" || parentID == "LI" ? (
                        <Box sx={{ marginRight: "5px" }}>
                          ...
                          <Checkbox
                                    checked={indentFlag}
                                    onChange={(e) => setIndentFlag(e.target.checked)}
                       ...
                       {parentID == "MI"  ? (
                        <Box sx={{ marginRight: "5px" }}>
                          ...
                          /> */}
                                 <Checkbox
                                    checked={jobworkFlag}
                                    onChange={(e) => setJobworkFlag(e.target.checked)}
                                    inputProps={{ 'aria-label': 'controlled' }}
                                  />
                          <FormLabel focused={false}>
                            Job Work
